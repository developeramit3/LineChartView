package www.develpoeramit.linechartview;
...
import www.develpoeramit.linechartviewlib.LineChartView;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btndoAnimation).setOnClickListener(this::doAnimation);
        findViewById(R.id.tableToggle).setOnClickListener(this::tableToggle);
        findViewById(R.id.bezierModelToggle).setOnClickListener(this::bezierModelToggle);
        findViewById(R.id.pointModelToggle).setOnClickListener(this::pointModelToggle);
